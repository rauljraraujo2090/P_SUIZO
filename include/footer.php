            ...
            <div class=container>
                <div class="footer_wrapper d-sm-flex flex-wrap flex-lg-nowrap justify-content-lg-between">
                    ...
                    <div class="footer_block col-sm-6 col-lg-auto" data-order=2>
                        <h5 class=footer_block-header>Información:</h5>
                        <ul class=footer_block-nav>
                            <li class=footer_block-nav_item>
                                <a class=link href=about.html>Acerca de este Proyecto</a>
                            </li>
                            <li class=footer_block-nav_item>
                                <a class=link href=contacts.html>Contactenos</a>
                            </li>
                            <li class=footer_block-nav_item>
                                <a class=link href=courses.html>Todos los cursos</a>
                            </li>
                            <li class=footer_block-nav_item>
                                <a class=link href=journal.html>Desde el Blog</a>
                            </li>
                            <li class=footer_block-nav_item>
                                <a class=link href=library.html>Biblioteca</a>
                            </li>
                            <li class=footer_block-nav_item>
                                <a class=link href=faq.html>Preguntas mas Frecuentes</a>
                            </li>
                        </ul>
                    </div>
                    <div class="footer_block col-sm-6 col-lg-auto m-sm-0" data-order=3>
                        ...
                        <ul class=footer_block-list>
                            <li class="footer_block-list_item d-flex align-items-baseline">
                                ...
                                <a class=link href=course.html>Conceptos básicos de ciencia de datos CS con Python y SQL</a>
                            </li>
                            <li class="footer_block-list_item d-flex align-items-baseline">
                                <span class=marker></span>
                                <a class=link href=course.html>Desarrollador Certificado AWS - Asociado 2024
                                </a>
                            </li>
                            <li class="footer_block-list_item d-flex align-items-baseline">
                                <span class=marker></span>
                                <a class=link href=course.html>Desarrollador Certificado AWS - Asociado 2020
                                </a>
                            </li>
                        </ul>
                    </div>
